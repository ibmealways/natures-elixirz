...
export default function VipFamilyAccess() {
  ...
  return <section className="vip-family-console" aria-labelledby="vip-family-title">
    <header><div><p className="ne-kicker">V.I.P. household protection</p><h3 id="vip-family-title">Family access</h3><p>Two family seats are available to qualifying V.I.P. subscribers in the introductory 5,000-household offer. Family accounts receive all digital tiers, but no merchandise or AI-generated food images.</p></div><button type="button" onClick={load} disabled={Boolean(busy)} aria-label="Refresh family access"><RefreshCcw size={16} /></button></header>
