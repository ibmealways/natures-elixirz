...
export default function NutritionFactsRegistry({ scope, pantryItems = [] }) {
  ...
  return <details className="nutrition-facts-registry">
    <summary><Database size={21} /><span><strong>Verified Nutrition Facts intake</strong><small>Connect branded foods, powders, fortified products, and exact scoop sizes</small></span><em>{labels.length} label{labels.length === 1 ? "" : "s"}</em></summary>
