...
const nutrients = (energyKcal, proteinG, fatG, carbohydrateG, fiberG, sugarG, potassiumMg, sodiumMg) => ({
  energyKcal, proteinG, fatG, carbohydrateG, fiberG, sugarG, potassiumMg, sodiumMg,
});
...
export const USDA_FOOD_IDENTITIES = Object.freeze({
  ...
  strawberries: { fdcId: 167762, description: "Strawberries, raw", dataType: "SR Legacy", preparationState: "raw", measures: { cup: { grams: 166, modifier: "sliced" } }, nutrientsPer100g: nutrients(32, 0.67, 0.3, 7.68, 2, 4.89, 153, 1) },
  banana: { fdcId: 173944, description: "Bananas, raw", dataType: "SR Legacy", preparationState: "raw", measures: { cup: { grams: 150, modifier: "sliced" } }, nutrientsPer100g: nutrients(89, 1.09, 0.33, 22.84, 2.6, 12.23, 358, 1) },
  mango: { fdcId: 169910, description: "Mangos, raw", dataType: "SR Legacy", preparationState: "raw", measures: { cup: { grams: 165, modifier: "pieces" } }, nutrientsPer100g: nutrients(60, 0.82, 0.38, 14.98, 1.6, 13.66, 168, 1) },
  ...
  spinach: { fdcId: 168462, description: "Spinach, raw", dataType: "SR Legacy", preparationState: "raw", measures: { cup: { grams: 30, modifier: "whole leaves" } }, nutrientsPer100g: nutrients(23, 2.86, 0.39, 3.63, 2.2, 0.42, 558, 79) },
  kale: { fdcId: 168421, description: "Kale, raw", dataType: "SR Legacy", preparationState: "raw", measures: { cup: { grams: 67, modifier: "chopped" } }, nutrientsPer100g: nutrients(35, 2.92, 1.49, 4.42, 4.1, 0.99, 348, 53) },
  ...
  carrot: { fdcId: 170393, description: "Carrots, raw", dataType: "SR Legacy", preparationState: "raw", measures: { cup: { grams: 128, modifier: "chopped" } }, nutrientsPer100g: nutrients(41, 0.93, 0.24, 9.58, 2.8, 4.74, 320, 69) },
  "rolled oats": { fdcId: 173904, description: "Cereals, oats, regular and quick, not fortified, dry", dataType: "SR Legacy", preparationState: "dry", measures: { cup: { grams: 81, modifier: "dry" } }, nutrientsPer100g: nutrients(379, 13.15, 6.52, 67.7, 10.1, 0.99, 362, 6) },
  "chia seeds": { fdcId: 170554, description: "Seeds, chia seeds, dried", dataType: "SR Legacy", preparationState: "dried", measures: { oz: { grams: 28.35, modifier: "dry" } }, nutrientsPer100g: nutrients(486, 16.54, 30.74, 42.12, 34.4, null, 407, 16) },
  "ground flaxseed": { fdcId: 169414, description: "Seeds, flaxseed", dataType: "SR Legacy", preparationState: "ground", measures: { tbsp: { grams: 7, modifier: "ground" }, tsp: { grams: 2.5, modifier: "ground" } }, nutrientsPer100g: nutrients(534, 18.29, 42.16, 28.88, 27.3, 1.55, 813, 30) },
...
export function calculateVerifiedNutrients(items = []) {
  const keys = ["energyKcal", "proteinG", "fatG", "carbohydrateG", "fiberG", "sugarG", "potassiumMg", "sodiumMg"];
